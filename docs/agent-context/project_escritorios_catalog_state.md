...
### Progreso fichas
- Creadas: 46 / (objetivo 50-100).
  - Lote 13 (4, 2026-07-21, media calidad 66.3): completar FlexiSpot ancla + best-sellers Amazon.es
    sin ficha. Specs de oficiales/reseñas, nunca inventadas. **Datos Amazon.es rellenados 2026-07-21** (usuario):
    `flexispot-q8` (77, Comhar Pro bambú doble motor 3 etapas 61-125cm/100kg/carga inalámbrica+cajón/10 años;
    B0FH2GJ32K, 699,99€ → tramo 4; textos de precio corregidos 550→700€),
    `songmics-lsd134` (66, #1 más vendido Amazon.es 3300 reseñas 4.5★, 140x60 1 motor 72-120cm/70kg/USB-C/4 mem; B0CV4VM2TR, 125,99€, tramo 1),
    `duronic-tm61` (63, marco eléctrico doble motor 72-120cm/80kg; B0C34FB93G, 175,99€, tramo 2; complementa TM00 manual),
    `duronic-cd120` (59, completo eléctrico 120x60 1 motor 72-118cm/70kg/patas nivelables; B0DKJPZWW9, 187,99€, tramo 2).
    `ikea-bekant` **descartado/eliminado 2026-07-21**: usuario no quiere fichas de productos descatalogados.
    Los 4 con ASIN → validan con imagen de Amazon (fallback). **Pendiente**: imágenes locales opcionales (nombre=slug).
  ...
  - Lote 9 (2, 2026-07-08, media calidad 81.5): specs de oficiales/reseñas.
    ...
    Yaheetech **saltado** (sin elevable eléctrico documentado). **Datos rellenados 2026-07-08**: ergotopia-lite
    (B09X1GPGJZ, 499€), autonomous (sin ASIN → buscar, 250€). Ambas con imagen.
