...
**Summary:** Estructura inicial del SEO engine creada, adaptada de patasyhogar.com para el nicho de home office y ergonomia.
**Triggered by:** user

## 2026-03-24 14:00
**Action:** Artículo creado — Mi setup de home office 2026
**Files:** src/content/articulos/mi-setup-home-office-2026.mdx, data/content-map.yaml, data/content-queue.yaml
**Summary:** Primer artículo del sitio. Tipo setup/informativo personal del autor (David Rubio) con ~2100 palabras. Incluye todos los productos del setup con experiencia personal. Pendiente: imagen destacada y ASINs de productos para enlaces de afiliado.
**Triggered by:** user

## 2026-03-24 16:00
**Action:** Artículo creado — Mejor silla ergonómica calidad-precio 2026
**Files:** src/content/articulos/mejor-silla-ergonomica-calidad-precio.mdx, data/content-map.yaml, data/content-queue.yaml, data/features.yaml, data/seo-keywords.csv, PRODUCTOS.md
**Summary:** Comparativa de 6 sillas ergonómicas (130-320 EUR) con ASINs verificados en Amazon.es. Imagen descargada de Pexels. Incluye experiencia personal del autor, pros/contras asimétricos, 6 FAQs, internal link al artículo de setup. Pendiente de revisión humana.
**Triggered by:** user

## 2026-03-24 16:30
**Action:** Blog aprobado — Mejor silla ergonómica calidad-precio 2026
**Files:** data/content-map.yaml, data/content-queue.yaml
...
## 2026-04-17 22:10
**Action:** Nueva herramienta — Calculadora de ergonomía
**Files:** src/pages/herramientas/index.astro, src/pages/herramientas/calculadora-ergonomia.astro, src/styles/global.css, public/images/og/calculadora-ergonomia.jpg, public/images/og/calculadora-ergonomia.svg, scripts/generate-og-calculadora.mjs, src/content/articulos/altura-correcta-escritorio-silla.mdx, src/content/articulos/ergonomia-teletrabajo-postura-correcta.mdx, src/content/articulos/dolor-espalda-trabajar-casa.mdx, src/content/articulos/ajustar-silla-oficina-correctamente.mdx, src/content/articulos/standing-desk-merece-la-pena.mdx, data/content-map.yaml
**Summary:** Engineering-as-marketing tool #1 (plan marketing). Calculadora interactiva ruta /herramientas/calculadora-ergonomia/: inputs estatura + peso + pulgadas monitor + uso sentado/pie → devuelve 6 medidas (silla, escritorio sentado, escritorio pie, top monitor, distancia monitor, profundidad asiento). Fórmulas ISO 9241 + Cornell (estatura × 0.26, 0.42, 0.63, 0.68). SVG dinámico a escala con figura humana + escritorio + monitor + medidas anotadas. Avisos contextuales según estatura fuera de rango o uso standing. 3 CTAs afiliado dinámicos (sillas, escritorios elevables, soporte monitor). Artículo acompañante 1500+ palabras con casos por estatura, errores frecuentes, FAQ (6 Qs). Schemas: SoftwareApplication + HowTo (5 pasos) + FAQPage + BreadcrumbList. 4 internal links bidireccionales añadidos desde cluster ergonomía. Imagen OG 1200x630 generada con sharp. Title 52 char, description 135 char. GA4 event tracking. CSP hashes auto-actualizados (11 hashes totales). Build OK 148 páginas.
**Triggered by:** user (plan marketing — herramienta #1 engineering-as-marketing)

## 2026-04-18 21:35
**Action:** Mantenimiento — bidireccionalidad internal linking (content-map.yaml)
**Files:** .seo-engine/data/content-map.yaml, scripts/fix-internal-links-bidirectional.py
**Summary:** Auditoría detectó ~75 asimetrías en internal_links_to/from tras añadir guia-completa-home-office (HUB), calculadora-ergonomia, ajustar-silla, mejor-silla-oficina-menos-200 y otros artículos nuevos — los `to` nuevos apuntaban a artículos antiguos cuyo `from` no se actualizó. Creado script Python `scripts/fix-internal-links-bidirectional.py` que (1) escanea cada MDX/Astro para extraer slugs reales vía regex /(categoria|guias|herramientas)/slug/, (2) sobrescribe `internal_links_to` con esos slugs reales (ordenados alfabéticamente + preservando items "categoría"), (3) invierte el grafo para regenerar `internal_links_from`. Resultado: 25 entries actualizadas, 25 cambios en `to` y 22 en `from`. Calculadora-ergonomia ahora aparece correctamente como `from` de 13 artículos. No afecta build (content-map.yaml no se importa en src/).
**Triggered by:** user (mantenimiento sábado — audit bidireccional)

## 2026-04-18 22:30
**Action:** Keyword research #25 — dolor-cervicales-ordenador (aprobado para lunes 20 abril)
**Files:** .seo-engine/data/seo-keywords.csv, .seo-engine/data/content-queue.yaml
**Summary:** Keyword research para artículo #25 (cluster sillas, tipo informativo). SERP analysis (Google ES): top 3 resultados son clínicas (Quirónsalud, Sanitas, Mapfre/Top Doctors) con enfoque genérico clínico sin contexto home office → intent INFORMATIONAL dominante, gap genuino para teletrabajador de 7 años con cervicalgia propia. PAA recolectadas: qué hacer cuando duele el cuello por ordenador, cómo se llama el dolor de cuello por ordenador, mejor postura cuello para pantalla, cuándo preocuparse. Keyword Surfer volúmenes (13 keywords añadidas a seo-keywords.csv): primary "dolor cervicales ordenador" (0, long-tail), secundarias 0 vol. Head terms con volumen real a embeber naturalmente: "cervicalgia" (12100, el más fuerte), "dolor cervical" (8100), "ejercicios para las cervicales" (2400), "estiramiento cuello" (1900), "estiramientos cervicales" (1600), "tech neck" (210). Cannibalization check vs dolor-espalda-trabajar-casa: menciona cervicales sólo en H3 breve → ángulo propio confirmado. Estrategia aprobada por usuario: slug "dolor-cervicales-ordenador", título "Dolor cervical por ordenador: causas y soluciones reales" (51 chars), meta 125 chars, 2000-2300 palabras, 8 secciones variadas (biomecánica cabeza adelantada, 3 síntomas tech neck, altura pantalla 80% problema, ajustes propios, ejercicios realistas 2-5min, red flags fisio, 5 FAQs), 6 internal links bidireccionales (dolor-espalda, ergonomia-teletrabajo, ajustar-silla, altura-correcta-escritorio-silla, tunel-carpiano, calculadora-ergonomia). Status: planned, date_planned 2026-04-20.
**Triggered by:** user (research sábado — preparación lunes)

## 2026-04-26 19:30
**Action:** Artículo #28 redactado — ikea-bekant-vs-flexispot-e7 (preparado para publicación lunes 27 abril)
**Files:** src/content/articulos/ikea-bekant-vs-flexispot-e7.mdx (NEW), src/content/articulos/mejor-escritorio-elevable-electrico.mdx (backlink), src/content/articulos/standing-desk-merece-la-pena.mdx (backlink), .seo-engine/data/content-map.yaml, .seo-engine/data/topic-clusters.yaml, .seo-engine/data/seo-keywords.csv, PRODUCTOS.md, public/images/articulos/ikea-bekant-vs-flexispot-e7.webp (Pexels 7899239 Josh Sorenson, 800px)
**Summary:** Comparativa VS (cluster escritorios). SERP top 5 (Sedda, 2 Reddits, FlexiSpot blog Comhar, Brittany Goldwyn) intent commercial_investigation con peso UGC. Sin PAA ni búsquedas relacionadas. Volúmenes Keyword Surfer 2026-04-26: primary "IKEA BEKANT vs FlexiSpot E7" 0, head terms con volumen real embebidos: "escritorio elevable ikea" 1300, "FlexiSpot E7" 720, "IKEA BEKANT" 480, "flexispot e7 pro" 480, "ikea escritorio elevable" 880, "BEKANT elevable" 110. Cannibalization check vs mejor-escritorio-elevable-electrico, standing-desk-merece-la-pena, altura-correcta-escritorio-silla → sin solapamiento. PIVOT estratégico durante research: ambos productos descatalogados (BEKANT confirmado por usuario buscando IKEA.es, E7 ya documentado en pilar). Ángulo: "comparativa de referencia + qué comprar ahora" — útil para gente con producto en casa, en Wallapop, o decidiendo entre marcas. ~2700 palabras, 6 FAQs, intro contraposición, estructura variada (spoiler corto al inicio, sin "Qué es X", incluye sección "El criterio que casi nadie menciona"). Productos referenciados: alternativas Amazon afiliadas reutilizadas del pilar (FlexiSpot EC5 PRO, E1 PRO, Maidesite EL2 Pro Art, JUMMICO, ErGear, SANODESK QS+) + URL externa IKEA MITTZON 429€ (sin afiliación, dato verificado por usuario). 3 internal links bidireccionales (mejor-escritorio-elevable-electrico, standing-desk-merece-la-pena, altura-correcta-escritorio-silla). 2+ inserciones experiencia personal coherentes con persona David Rubio (despacho 8m² Barcelona, FlexiSpot E7 con bambú 140×70, fisioterapeuta, hijo de año y medio). 11 keywords añadidas a seo-keywords.csv. Status: human-review, fecha 2026-04-27.
**Triggered by:** user ("vamos con el artículo de mañana y lo dejamos preparado")

## 2026-05-10 16:00
**Action:** Artículo #29 redactado — trabajar-desde-casa-calor (preparado para publicación lunes 11 may)
**Files:** src/content/articulos/trabajar-desde-casa-calor.mdx (NEW), .seo-engine/data/content-map.yaml, .seo-engine/data/topic-clusters.yaml, .seo-engine/data/seo-keywords.csv, .seo-engine/data/content-queue.yaml
**Summary:** Primer artículo post-recovery indexación (cadencia 1/sem). Info ambiente, estacional jun-ago. SERP top 5 (eltiempo, pagepersonnel, grupoclave, hola.com, rrhhdigital) intent INFORMATIONAL puro — sin product pages, sin PAA, sin búsquedas relacionadas. Volúmenes Keyword Surfer 2026-05-10: primary "trabajar desde casa calor" 0, todas candidatas 0. Head term real con volumen masivo descubierto vía Keyword ideas sidebar: "ventilador silencioso" 9900 (precarga #30 mejor-ventilador-silencioso-oficina del 18 may). Estrategia: Info con sección dedicada "Ventilador silencioso para teletrabajar" que prepara cluster bridge. Ángulo único frente a SERP: las 5 top dan consejos genéricos sin datos técnicos. #29 incluye datos verificables: INSST RD 486/1997 (17-27°C), AEMET centro/sur 25-30 días/año >35°C, Helsinki University of Technology (caída 2%/grado tareas cognitivas via OMS), IDAE (consumo AC +7-10% por grado <25°C), watts radiados monitor 4K (35-50W), torre PC (80-200W), bombilla halógena vs LED. Estructura no estándar (cumple regla anti-IA): intro anecdótica termómetro 33,4°C en Rubí julio → realidad térmica España → 3 capas en orden coste/efecto (bloquear/circular/climatizar) → bridge ventilador silencioso (5 criterios técnicos) → 5 errores contraintuitivos (monitor, torre, halógenas, cortinas oscuras, ventilación matinal mal hecha) → rutina térmica 8:00-19:30 Rubí 9m² norte → cuándo AC ya no opcional (5 condiciones) → más allá del aire → resumen. NO usa "Qué es X / Tipos / FAQ". 2204 palabras body. 6 FAQs (variable, no 5). 4 internal links: mejor-escritorio-elevable-electrico, mejor-monitor-trabajar-desde-casa, insonorizar-home-office, productividad-en-casa-entorno-fisico. Coherencia persona David Rubio: Rubí 9m² orientación norte (canónico de project_author_persona.md), BenQ PD2705U, FlexiSpot E7, mujer trabaja habitación sur 35°C, lector Sevilla con ventilador 56dB compró torre brushless 80€, fisioterapeuta Pep contractura trapecio derecho hace dos veranos. Fuentes: INSST RD 486/1997, AEMET Sabadell 2025 (41,1°C), Helsinki University of Technology citado por OMS, IDAE. Humanizer pass: corregido único negative parallelism crítico ("no es una compra: es un protocolo"). Bold inline-headers conservados (consistente con voz site, mismo patrón en insonorizar-home-office y mejor-lampara-escritorio-led). 18 keywords añadidas a seo-keywords.csv: 7 candidatas vol 0 #29 + 11 head terms cluster ventilador (vol 9900 a 590) mapeadas a #30 planned. Status: human-review, fecha 2026-05-11. Imagen Pexels pendiente.
**Triggered by:** user (vamos con el plan de hoy — domingo prep #29)

## 2026-05-12 12:00
**Action:** Recovery Bloque B pieza 3 — refactor mejor-lampara-escritorio-led
