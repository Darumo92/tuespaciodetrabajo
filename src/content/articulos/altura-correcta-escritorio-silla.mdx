---
titulo: "Altura correcta de escritorio y silla: calcula la tuya"
...
Esto te da la altura de la superficie de trabajo donde apoyas los antebrazos. Si prefieres introducir tus datos y que te salga el cálculo hecho (incluyendo monitor y casos de escritorio elevable), monté una [calculadora de ergonomía interactiva](/herramientas/calculadora-ergonomia/) que hace exactamente eso. Aquí tienes las cifras para las estaturas más comunes:
...
La silla se ajusta **antes** que el escritorio. Es un error muy común hacer al revés: fijar la mesa y después intentar que la silla encaje. La secuencia correcta es esta (si quieres el detalle de cada ajuste por separado, tengo una guía específica sobre [cómo ajustar la silla de oficina paso a paso](/guias/ajustar-silla-oficina-correctamente/) con las seis regulaciones en orden):
...
Si también usas la mesa para estudiar, la guía para [elegir un escritorio con espacio para portátil y apuntes](/guias/como-elegir-escritorio-estudiar/) te ayuda a comprobar la superficie, además de la altura.
...
Si quieres saber más sobre la experiencia real de usar un standing desk a diario, escribí un [artículo dedicado a eso](/guias/standing-desk-merece-la-pena/).
...
La referencia: **el borde superior del monitor debe quedar a la altura de tus ojos** cuando miras al frente con la cabeza recta. Si trabajas con un portátil sin pantalla externa, esto es prácticamente imposible sin un soporte elevador. No necesitas un soporte caro: una pila de libros funciona, y un [brazo articulado desde 27 EUR](/accesorios/mejor-soporte-monitor-brazo-articulado/) te da ajuste preciso al milímetro. La [diferencia para las cervicales es enorme](/guias/dolor-cervicales-ordenador/) — en ese artículo explico en detalle por qué la altura de la pantalla es el 80% del dolor de cuello en teletrabajadores.
