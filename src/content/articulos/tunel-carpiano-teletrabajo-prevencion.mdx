...
Para una visión más amplia de la postura correcta (no solo muñecas, sino espalda, cuello y piernas), tengo una [guía completa de ergonomía para teletrabajadores](/guias/ergonomia-teletrabajo-postura-correcta/). Si el hormigueo viene acompañado de rigidez cervical o cefalea tensional, puede que el origen esté más arriba — en la [cervicalgia por ordenador](/guias/dolor-cervicales-ordenador/) explico cómo diferenciarla del túnel carpiano puro. Y si el [dolor de espalda](/guias/dolor-espalda-trabajar-casa/) también te suena, probablemente necesites revisar tu setup de arriba abajo.
