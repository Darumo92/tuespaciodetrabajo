...
**Antes de seguir, una nota:** no soy fisioterapeuta ni profesional sanitario. Soy un ingeniero de software que lleva siete años teletrabajando y que ha aprendido a base de equivocarse — y de pagar 300 € en seis sesiones de fisio post-confinamiento por aprender por las malas. Las recomendaciones que vienen son combinación de experiencia personal, lo que Pep me ha ido enseñando consulta a consulta, y guías oficiales como las del [Instituto Nacional de Seguridad y Salud en el Trabajo (INSST)](https://www.insst.es/), la [Cornell University Ergonomics Web](https://ergo.human.cornell.edu/AHTutorials/ckpttoc.html) y el [Instituto de Biomecánica de Valencia (IBV)](https://www.ibv.org/wp-content/uploads/2022/03/GUIA-Teletrabajo.pdf). Si tu dolor es agudo, irradiado o llevas más de 2-3 semanas con molestias que no ceden con los ajustes de esta guía, ve directamente a un profesional.

Si quieres saber cómo trabajo las guías del sitio, he dejado explicado el proceso en la [metodología editorial](/metodologia-editorial/) y en la página de [cómo pruebo y elijo productos](/como-probamos-productos/). Esta guía es informacional: no incluye botones de compra ni pretende sustituir una valoración profesional.
...
## Plan de 7 días para corregir tu postura sin comprar nada

La postura de teletrabajo mejora más rápido si la tratas como una revisión de sistema, no como una compra impulsiva. Antes de pedir una silla nueva o un escritorio elevable, dedica una semana a ajustar lo que ya tienes. Así sabrás qué problema es real y qué problema estaba creado por una mala configuración.

Este es el plan que uso cuando alguien me escribe con la duda de siempre: "me duele la espalda, pero no sé por dónde empezar". No sustituye a un fisioterapeuta, pero te obliga a mirar el setup con orden.

| Día | Ajuste | Qué medir |
|---|---|---|
| 1 | Haz una foto lateral de tu postura real, sin corregirte para la foto. | Cuello inclinado, hombros elevados, espalda separada del respaldo. |
| 2 | Ajusta la altura de la silla hasta que los pies apoyen completos. | Rodillas cerca de 90-110° y muslos sin presión en el borde del asiento. |
| 3 | Coloca pantalla y portátil a altura de ojos. | Si lees sin bajar la barbilla y sin adelantar la cabeza. |
| 4 | Acerca teclado y ratón al cuerpo. | Codos cerca del torso, muñecas neutras, hombros relajados. |
| 5 | Prueba la regla 50-10 durante una jornada. | Dolor lumbar o cervical a las 12:00, 15:00 y final del día. |
| 6 | Revisa luz y reflejos en pantalla. | Si entrecierras los ojos, acercas la cara o acabas con cefalea. |
| 7 | Repite la foto lateral y compara. | Qué ha mejorado y qué sigue igual aunque ajustes todo. |

El día 1 es incómodo porque ves cosas que no notas mientras trabajas. En mi caso, la primera foto que me hizo mi mujer en el salón fue bastante clara: portátil bajo, barbilla adelantada y hombros subidos. Yo juraba que estaba "más o menos bien". No lo estaba.

El día 5 es el más revelador. Si al aplicar pausas reales cada 50 minutos baja el dolor, el problema no es solo la silla: es la falta de movimiento. Si no cambia nada, toca mirar con más cuidado la altura del escritorio, el respaldo, el monitor o incluso una molestia previa que requiera valoración profesional.

No compres nada durante esos siete días salvo que detectes una limitación evidente. Por ejemplo: si subes la silla para alcanzar una mesa alta y los pies quedan colgando, un reposapiés barato puede ser el primer ajuste lógico. Si la pantalla queda baja porque trabajas con portátil, un soporte y un teclado externo suelen resolver más que cambiar de silla. La idea es gastar después de diagnosticar, no antes.

Al final de la semana deberías tener tres datos muy concretos:

- **Qué ajuste redujo molestias.** Pantalla, altura de silla, teclado, pausas o luz.
- **Qué limitación no puedes corregir con lo que tienes.** Mesa demasiado alta, silla sin soporte lumbar, portátil sin soporte, falta de espacio.
- **Cuándo aparece el dolor.** Desde primera hora, después de comer, al final del día o tras tareas concretas como videollamadas o ratón intensivo.

Con eso, cualquier decisión de compra o visita al fisio será mucho más precisa. Y si tu dolor no mejora nada en una semana de ajustes razonables, no lo estires otro mes por orgullo: ahí conviene pedir ayuda profesional.
...
Pep me lo explicó con una frase que se me quedó grabada: "Si tienes que pensar en tu postura, tu silla no está haciendo su trabajo". Desde que cambié a una silla con soporte lumbar regulable en altura y profundidad, la diferencia fue brutal. Antes de plantearte cambiar de silla, merece la pena revisar si la que tienes está bien regulada — muchas molestias lumbares se resuelven con [un buen ajuste paso a paso de la silla](/guias/ajustar-silla-oficina-correctamente/). Si ya la has ajustado y sigues igual, tengo una [guía de sillas ergonómicas calidad-precio](/sillas/mejor-silla-ergonomica-calidad-precio/) que puede ayudarte. Y si quieres empezar un setup ergonómico desde cero, descubre cómo [crear un espacio productivo por menos de 500 €](/guias/home-office-productivo-500-euros/).
...
Un soporte para portátil o un [buen monitor externo](/accesorios/mejor-monitor-trabajar-desde-casa/) con soporte regulable en altura cambian completamente la ecuación. Cuando montamos [mi setup actual](/guias/mi-setup-home-office-2026/), una de las primeras inversiones fue precisamente un [brazo de monitor](/accesorios/mejor-soporte-monitor-brazo-articulado/) que me permitió ajustar la pantalla al milímetro.
...
2. **Después el escritorio.** La superficie debe quedar a la altura de tus codos cuando están en ángulo de 90°. Para la mayoría de personas, eso está entre 65 y 75 cm del suelo. Si quieres la cifra exacta para tu estatura, te la saca la [calculadora de ergonomía](/herramientas/calculadora-ergonomia/) con figura a escala.
...
La mayoría no tenemos un escritorio elevable (aunque son una gran inversión si puedes permitírtelo — [cuento mi experiencia real con uno](/guias/standing-desk-merece-la-pena/)). Si tu mesa tiene una altura fija de 74-75 cm — que es el estándar en España — ajusta todo lo demás alrededor:
...
No hace falta gastarse 2.000 EUR de golpe. Mi primer setup "ergonómico" fue un soporte de portátil de 25 EUR y un teclado externo de 30 EUR. Solo eso ya cambió más que cualquier otra cosa. Si te planteas armar un espacio de trabajo completo y no sabes por dónde empezar, tengo una [guía con todo lo que necesitas para montar tu home office](/guias/guia-completa-home-office/) paso a paso.
